...
class heatmapGenerator:
    ...
    def run(self):
        ...
        sd = Utils.create_dir(self.path + 'maps/'+ str(self.filename) + '/')
        print(sd)
    ...
    def parse_store_csv(self):
        ...
        with open('store_csv/' + str(self.filename) + '.csv', 'r') as file:
    ...
    def hotmap_creator(self,val):
        ...
        self.hotmap= cv2.putText(self.hotmap, 'Hotmap', (100, 100), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (255.0), cv2.LINE_AA)
        self.coldmap=cv2.putText(self.coldmap, 'Coldmap', (100, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, cv2.CV_8U(0.0), 1,2)
